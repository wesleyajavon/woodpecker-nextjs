export const termsContent = `<div data-custom-class="body">
  ...
  <div data-custom-class="subtitle">
    <strong>Last updated October 14, 2025</strong>
  </div>
  ...
  <div data-custom-class="body_text">
    <p>We are l.outsider ("Company," "we," "us," "our"), a company registered in Belgium at 32 Rue de Dampicourt, Saint-Mard, Luxembourg 6762.</p>
    
    <p>We operate the website <a data-custom-class="link" href="https://loutsider.vercel.app/">https://loutsider.vercel.app/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
    
    <p>You can contact us by phone at +18645633182, email at <a data-custom-class="link" href="mailto:wesleyajavon2203@hotmail.com">wesleyajavon2203@hotmail.com</a>, or by mail to 32 Rue de Dampicourt, Saint-Mard, Luxembourg 6762, Belgium.</p>
    
    <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and l.outsider, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
  ...
  <div data-custom-class="body_text">
    <ul>
      ...
      <li><a data-custom-class="link" href="#products">4. PRODUCTS</a></li>
      <li><a data-custom-class="link" href="#purchases">5. PURCHASES AND PAYMENT</a></li>
      <li><a data-custom-class="link" href="#refunds">6. REFUNDS POLICY</a></li>
      <li><a data-custom-class="link" href="#prohibited">7. PROHIBITED ACTIVITIES</a></li>
      <li><a data-custom-class="link" href="#ugc">8. USER GENERATED CONTRIBUTIONS</a></li>
      <li><a data-custom-class="link" href="#license">9. CONTRIBUTION LICENSE</a></li>
      <li><a data-custom-class="link" href="#sitemanage">10. SERVICES MANAGEMENT</a></li>
      <li><a data-custom-class="link" href="#privacy">11. PRIVACY POLICY</a></li>
  ...
  <div id="products" data-custom-class="heading_1">
    <h2>4. PRODUCTS</h2>
  </div>
  ...
  <div id="purchases" data-custom-class="heading_1">
  ...
  <div id="refunds" data-custom-class="heading_1">
  ...
  <div data-custom-class="body_text">
    ...
    <ul>
      ...
      <li>Resell or share the beats</li>
      <li>Resell or share the stems</li>
    </ul>
  </div>
  ...
  <div data-custom-class="body_text">
    <p>We care about data privacy and security. Please review our Privacy Policy: <a data-custom-class="link" href="https://loutsider.vercel.app/privacy">https://loutsider.vercel.app/privacy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
  </div>
  ...
  <div data-custom-class="body_text">
    <p>These Legal Terms are governed by and interpreted following the laws of Belgium, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. l.outsider and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Brussels, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in Belgium, or in the EU country in which you reside.</p>
  </div>
  ...
  <div data-custom-class="body_text">
    ...
    <p><strong>l.outsider</strong><br>
    32 Rue de Dampicourt<br>
    Saint-Mard, Luxembourg 6762<br>
    Belgium<br>
    Phone: +18645633182<br>
    <a data-custom-class="link" href="mailto:wesleyajavon2203@hotmail.com">wesleyajavon2203@hotmail.com</a></p>
  </div>
</div>`;