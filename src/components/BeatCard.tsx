...
export default function BeatCard({ 
  ...
  return (
    <motion.div
      className={`bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 overflow-hidden hover:border-gray-600 transition-all duration-300 ${className}`}
      whileHover={{ y: -2 }}
    >
      {/* Image/Artwork */}
      <div className="relative aspect-square bg-gradient-to-br from-purple-900/20 to-blue-900/20">
        ...
        <div className="absolute top-2 right-2">
          <div className={`px-2 py-1 rounded-full text-xs font-medium bg-gray-900/80 ${licenseColors[selectedLicense]}`}>
              ...
              <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-left">
                      <div className="flex items-center gap-2">
                        <h4 className="font-semibold text-white">WAV Lease</h4>
                        {selectedLicense === 'WAV_LEASE' && (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="text-left">
                      <div className="flex items-center gap-2">
                        <h4 className="font-semibold text-white">Trackout Lease</h4>
                        {selectedLicense === 'TRACKOUT_LEASE' && (
                          <Check className="w-4 h-4 text-purple-400" />
                        )}
                      </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="text-left">
                      <div className="flex items-center gap-2">
                        <h4 className="font-semibold text-white">Unlimited Lease</h4>
                        {selectedLicense === 'UNLIMITED_LEASE' && (
                          <Check className="w-4 h-4 text-purple-400" />
                        )}
                      </div>
