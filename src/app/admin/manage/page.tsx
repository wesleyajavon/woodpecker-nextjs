    ...
    <div className="flex-1 pt-16 sm:pt-20 pb-8 sm:pb-12 px-3 sm:px-4 lg:px-8 relative">
            ...
            <div className="max-w-6xl mx-auto py-4 sm:py-8 relative z-10">
              ...
              >
                ...
                <BeatManager
                  onEdit={(beat) => {
                    // Navigation vers la page de gestion du beat
                    window.location.href = `/admin/beats/${beat.id}`;
                  }}
                  onDelete={(beatId) => {
                    // TODO: Rafraîchir la liste après suppression
                    console.log('Beat deleted:', beatId);
                  }}
                  onToggleStatus={(beatId, isActive) => {
                    // TODO: Rafraîchir la liste après changement de statut
